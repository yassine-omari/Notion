...
const faqs = [
    ...
    },
    {
        ...
        a: "Paid plans come with a 7-day free trial. No credit card needed to start.",
    },
    {
        q: "What happens to my data if I downgrade?",
        a: "Your pages are safe. You may lose access to features, but nothing is deleted.",
    },
    {
        q: "Do you offer discounts for students or nonprofits?",
        a: "Yes — students and eligible nonprofits get Notion Plus free. Apply on our website.",
    },
];
...
export default function PricingPage() {
    ...
    return (
        <main className="min-h-screen bg-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {plans.map((plan, i) => (
                        ...
                        >
                            ...
                            <button
                                className={`w-full py-3 rounded-full text-sm font-medium mb-8 transition-colors ${plan.featured ? "bg-white text-gray-950 hover:bg-gray-100" : "bg-gray-950 text-white hover:bg-gray-800"}`}
                            >
                                {plan.cta}
                            </button>
                            ...
                            <ul className="space-y-3 mt-auto">
                                {plan.features.map((f) => (
                                    <li key={f} className="flex items-start gap-2.5 text-sm">
                                        <svg
                                            className={`w-4 h-4 mt-0.5 flex-shrink-0 ${plan.featured ? "text-white" : "text-gray-950"}`}
            ...
            >
                <div className="border border-gray-100 rounded-2xl px-10 py-12 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div>
                        ...
                        <h2 className="text-3xl font-serif text-gray-950 mb-2">Need something bigger?</h2>
                        <p className="text-gray-500 text-sm max-w-md">
                            Custom contracts, volume pricing, advanced security, and dedicated support for large organizations.
                        </p>
                    </div>
                    <ButtonWithIconDemo title="Talk to sales" />
                </div>
            </motion.section>
            ...
            <motion.section
                variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }}
                className="px-6 pb-32 max-w-3xl mx-auto"
            >
                <h2 className="text-3xl font-serif text-gray-950 mb-10 text-center">Common questions</h2>
