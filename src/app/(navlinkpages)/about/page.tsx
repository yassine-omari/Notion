...
const values = [
    {
        ...
        description: "We believe software should get out of your way. Every feature we ship is a bet that simplicity scales better than power.",
    },
    {
        title: "Built for humans",
        description: "Your workspace should feel like yours. We design for adaptability so Notion works the way you think, not the other way around.",
    },
    {
        title: "Long-term thinking",
        description: "We're building a company we'd want to use ourselves — one that makes thoughtful tradeoffs and earns trust over time.",
    },
];
...
export default function AboutPage() {
    return (
        <main className="min-h-screen bg-white">
            ...
            {/* Mission */}
            <section className="px-6 pb-24 max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                <motion.div
                ...
                >
                    ...
                    <h2 className="text-4xl font-serif text-gray-950 leading-snug mb-6">
                ...
                >
                    {values.map((v) => (
                        <div key={v.title} className="border-b border-gray-100 pb-6 last:border-0 last:pb-0">
                            <h3 className="font-semibold text-gray-950 mb-2">{v.title}</h3>
            ...
            >
                <div className="border border-gray-100 rounded-2xl px-10 py-14 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div>
                        <h2 className="text-3xl font-serif text-gray-950 mb-2">Want to join us?</h2>
